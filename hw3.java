...
//        txtOutput.append("a1 * b = " + t[0] + ", "  + t[1] +  "\r\n");
        ...
        c /= loop;
        txtOutput.append("\r\n");
        txtOutput.append("k average for " + loop + " times = " + c +  "\r\n");
        txtOutput.append("Time to run = " + (stopTime - startTime) + " miliseconds");
